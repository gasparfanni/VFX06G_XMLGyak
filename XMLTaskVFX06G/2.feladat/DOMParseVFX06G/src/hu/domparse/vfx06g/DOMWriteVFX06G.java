...
public class DOMWriteVFX06G {
	public static void main(String argv[]) throws Exception {
		...
		root.appendChild(createKedvezmeny(doc, "1", "2023.05.12", "Manikűr"));
		root.appendChild(createKedvezmeny(doc, "2", "2023.05.12", "Manikűr"));
		root.appendChild(createKedvezmeny(doc, "3", "2023.05.12", "Manikűr"));
		...
		root.appendChild(createVendeg(doc, "1", "1", "06301234567", "kovacsnora@gmail.com", "25000", "Kovács Nóra"));
		root.appendChild(createVendeg(doc, "2", "2", "06705555555", "szabo.andras@gmail.com", "", "Szabó András"));
		root.appendChild(createVendeg(doc, "3", "3", "06708887777", "molnar.rita@gmail.com", "12000", "Molnár Rita"));
		...
		File myFile = new File("VFX06G_write.xml");
	...
	private static Node createKedvezmeny(Document doc, String kedvezmeny_id, String elsoIdopont, String szolgaltatas) {
		...
		kedv.appendChild(createElement(doc, "szolgaltatasok", szolgaltatas));
	...
	private static Node createVendeg(Document doc, String vendeg_id, String kedvezmeny_id, String telefonszam, String email, String fizetett,
			String nev) {

		Element v = doc.createElement("vendeg");

		v.setAttribute("vendeg_id", vendeg_id);
		v.setAttribute("kedvezmeny_id", kedvezmeny_id);
